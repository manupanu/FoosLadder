...
export default function PlayerStatsPanel({ playerId, onClose }: { playerId: string; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        className="bg-gradient-to-br from-charcoal-700 to-charcoal-800 rounded-xl shadow-2xl p-6 w-full max-w-md relative animate-fadeInUp border border-persian_green-500/30 flex flex-col max-h-[90vh] overflow-hidden" // Added flex, flex-col, max-h, overflow-hidden
      ...
      >
        ...
        <div className="flex-shrink-0">
          <button
            onClick={onClose}
            className="absolute top-4 right-4 text-saffron-400 hover:text-saffron-300 text-3xl font-light transition-colors z-10" // Ensure button is above content
        ...
        <div className="flex-grow overflow-y-auto pr-2"> {/* Added flex-grow, overflow-y-auto, and some padding-right for scrollbar */}
