...
// Use system fonts as fallback for reliability
const fontVariables = "font-sans"; // Use Tailwind's built-in font stack

export const metadata: Metadata = {
  title: "FoosLadder - Foosball Score Tracking",
  description: "Track foosball scores, player ELO ratings, and game history with our modern, responsive web application.",
  icons: {
    icon: "/foosball-favicon.svg",
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${fontVariables} antialiased flex flex-col min-h-screen font-sans`}
      >
        <main className="flex-grow">{children}</main>
        <footer className="bg-gray-800 text-white text-center p-4">
          <p className="mb-2">Foosball Ladder © 2025 - Built with ⚽ and 🔥</p>
          <a
            href="https://github.com/manupanu/FoosLadder"
            target="_blank"
